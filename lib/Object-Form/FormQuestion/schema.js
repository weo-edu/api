...
FormQuestionSchema.method('isCorrect', function(answer) {
  return this.correctAnswer !== undefined && answer === this.correctAnswer;
});
...
FormQuestionSchema.PollQuestion = FormQuestionSchema.discriminator('pollQuestion');
FormQuestionSchema.QuizQuestion = FormQuestionSchema.discriminator('quizQuestion', {
  correctAnswer: {
    type: String,
    required: true
  }
