...
var SchemaEvents = function(Schema) {
  ...
  Schema.post('save', function() {
    if(this.wasNew) {
      Schema.postDispatch('post:add', this);
      delete this.wasNew;
    } else {
      Schema.postDispatch('post:change', this);
    }
  });
  ...
  Schema.post('remove', function() {
    Schema.postDispatch('post:remove', this);
  });
  ...
  Schema.post('validate', function() {
    Schema.postDispatch('post:validate', this);
  });
  ...
  Schema.post('save', function() {
    ...
    SchemaEvents.onFlush(function() {
      self.$previous = self.toObject({depopulate: 1});
    });
  });
};
