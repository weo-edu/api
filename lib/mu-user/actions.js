...
const lowercaseUsername = converge(assoc('username'), compose(toLowerSafe, prop('username')), identity);
const lowercaseEmail = converge(assoc('email'), compose(toLowerSafe, prop('email')), identity);
