...
//app.use(require('express-inject-latency')({mean: 200, variance: 20}));

if(app.get('env') === 'development') {
  var inject = injectLatency({mean: 200, variance: 20});
  app.use(function(req, res, next) {
    console.log('here', req.query.hasOwnProperty('latency'));
