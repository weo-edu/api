...
Share.schema.when('post:add', hooks.aggregateChannel(true));
...
Share.schema.when('post:change:_object.0.points.scaled', hooks.aggregateChannel());
Share.schema.when('post:change:status', hooks.aggregateChannel());
