...
// Aggregate channel must come before the broadcast hooks
// until we figure out what to do about populateSelfLinks
// altering the contents of shares
...
Share.schema.when('pre:change:status', hooks.autoGrade());
