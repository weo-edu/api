...
app.post('/template/:id'
  , lookup(Share)
  , user.middleware.me()
  , app.actions.copyTemplate)
...
app.put('/:id/assign'
  ...
  , middleware.updateUserAssigns
  , middleware.sendTo('class')
  , notify.assigned
  , actions.success)
...
app.put('/:id/pin'
  ...
  , app.middleware.updateUserPins
  , notify.pinnedActivity
  , middleware.sendTo('board')
  , actions.success)
...
app.put('/:id/like'
  , lookup(Share)
  , user.middleware.me()
  , notify.likedActivity
  , actions.like)

app.put('/:id/unlike'
  , lookup(Share)
  , user.middleware.me()
  , notify.unlikedActivity
  , actions.unlike)
...
app.post('/'
  ...
  , middleware.ifType('comment', notify.commentedOnActivity)
  , middleware.ifType('annotation', notify.annotated)
  , actions.create)
...
app.del('/:id'
  ...
  , user.middleware.me()
  , app.middleware.ifPublic(app.middleware.decrementPinCount)
...
app.put('/:id/max_points/:questionId'
  , lock.middleware('id')
  , user.middleware.me()
  , lookup(Share)
  , middleware.canEdit(Share)
  , actions.setMaxPoints)
