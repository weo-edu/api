...
app.put('/:id/instance'
  , lookup(Share)
  , lock.middleware(function(req) { return req.share.root.id; })
...
//Share.schema.when('post:change', Share.schema.eventFilter('status', '_object.0.points.scaled', hooks.aggregateChannel()));
