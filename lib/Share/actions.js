...
exports.publish = function(req, res, next) {
  req.share.status = Share.status.ACTIVE;
  exports.save(req, res, next);
};

exports.queue = function(req, res, next) {
  req.share.status = Share.status.QUEUED;
  exports.save(req, res, next);
};

exports.returnInstance = function(req, res, next) {
  req.share.status = Share.status.RETURNED;
  exports.save(req, res, next);
};
