...
ShareSchema.method('createStatus', function(statusName, actor) {
  actor = actor || this.actor.toJSON()

  var User = mongoose.model('User')
  var evt = this.createChild('status', {channels: [User.path(actor, 'activities')]})
...
ShareSchema.method('createNotification', function(recipient, statusName, actor) {
  var User = mongoose.model('User')
  var evt = this.createChild('status', {
    channels: [User.path(recipient, 'notifications')]
  })
