...
// ShareSchema.method('createInstance', function(context, user) {
//   // var inst = this.createChild('shareInstance', {
//   //   contexts: [context],
//   //   channels: [
//   //   ]
//   // });
...
module.exports = ShareSchema.Model = mongoose.model('Share', ShareSchema);