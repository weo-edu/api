module.exports = {
  ...
  mongo: {
    url: process.env.MONGODB_URI || process.env.MONGOHQ_URL || process.env.MONGO_URL || 'mongodb://localhost:27017/eos'
  },
  redis: {
    url: process.env.REDISTOGO_URL || process.env.REDIS_URL || 'redis://127.0.0.1:6379'
  },
  avatar: 'http://avatar.eos.io/',
  userProfile: process.env.NODE_ENV === 'production' ? 'http://weo.io/' : 'http://localhost:3000/'
};