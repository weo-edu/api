...
app.put('/:id/gradeLevels'
  , lookup(User)
  , app.middleware.me()
  , app.middleware.canEditUser('gradeLevels')
  , app.actions.editField('gradeLevels'))

app.put('/:id/subjects'
  , lookup(User)
  , app.middleware.me()
  , app.middleware.canEditUser('subjects')
  , app.actions.editField('subjects'))
