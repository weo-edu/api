...
function nameValidate() {
  return this.name.honorificPrefix || this.name.givenName || this.name.familyName;
}

UserSchema.path('name.givenName').validate(nameValidate);
UserSchema.path('name.familyName').validate(nameValidate);
UserSchema.path('name.honorificPrefix').validate(nameValidate);
